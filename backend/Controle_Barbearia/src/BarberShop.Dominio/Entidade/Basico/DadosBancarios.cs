...
{
    [DebuggerStepThrough]
    [Table("dadosbancarios", Schema = "public")]
    public class DadosBancarios
    {
        ...
        [Required(ErrorMessage = "obrigatório informar a propriedade: idtipochavepix", AllowEmptyStrings = false)]
        [Column("idtipochavepix", Order = 2, TypeName = "bigint")]
        public long IdTipoChavePix { get; set; } = default!;
        ...
        [NotMapped]
        [Required(ErrorMessage = "obrigatório informar a senha de confirmação para criptografar a chave PIX", AllowEmptyStrings = false)]
