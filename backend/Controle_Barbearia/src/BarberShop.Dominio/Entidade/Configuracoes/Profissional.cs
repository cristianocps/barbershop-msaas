...
{
    [DebuggerStepThrough]
    [Table("profissionais", Schema = "public")]
    public class Profissional
    {
        ...
        [DataType(DataType.Text)]
        [MaxLength(7, ErrorMessage = "tamanho máximo 7 caracteres")]
        [Column("cor_agenda", Order = 6, TypeName = "varchar(7)")]
        public string CorAgenda { get; set; } = "#000000";
