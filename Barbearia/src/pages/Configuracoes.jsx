...
import { Settings, Edit2, Trash2, DollarSign } from 'lucide-react';
...
export function Configuracoes() {
    ...
    const handleInativar = (id) => {
        askConfirm({
            ...
            message: 'Deseja inativar/ativar este serviço do catálogo?',
            type: 'warning',
    ...
    const formatUnit = (row) => row.unidade || row.Unidade || 'UN';
    ...
    return (
        <div>
            <PageHeader
                icon={<Settings />}
                title="Configurações"
                subtitle="Serviços do estabelecimento"
            ...
            <DataGrid
                ...
                emptyIcon={<Settings size={24} color="var(--text-muted)" />}
